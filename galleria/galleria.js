...
const showHideIcons3 = () => {
    // showing and hiding prev/next icon according to carousel scroll left value
    let scrollWidth3 = carousel2.scrollWidth - carousel3.clientWidth; // getting max scrollable width
...
arrowIcons3.forEach(icon => {
    icon.addEventListener("click", () => {
        let firstImgWidth3 = firstImg3.clientWidth + 14; // getting first img width & adding 14 margin value
        // if clicked icon is left, reduce width value from the carousel scroll left else add to it
